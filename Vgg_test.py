...
dropout_rate = 0.5
momentum_rate = 0.9
log_save_path = 'log/vgg_19'
model_save_path = 'models/vgg19'
...
if __name__ == '__main__':
    ...
    out5_4 = tf.nn.relu(batch_norm(conv2d(out5_3, W_conv5_4) + b_conv5_4))

    # output = tf.contrib.layers.flatten(output)
    output = tf.reshape(out5_4, [-1, 2*2*512])
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "models/vgg19")
